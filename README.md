# 🚀 BridgeLabz Training –  Learning Journey

Welcome to my **BridgeLabz Training Repository** 👋  
This repository documents my **day-wise learning, hands-on practice, and code submissions** during the BridgeLabz training program.
...
🔗 **Code Link:**  
👉 https://github.com/wanjarisaurabh/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/control-flows
...
🔗 **Code Link:**  
👉 https://github.com/wanjarisaurabh/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/arrays
...
- Code reusability & clean practices

🔗 **Code Link:**  
👉 https://github.com/wanjarisaurabh/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/java-methods
...
🔗 **Code Link:**  
👉 https://github.com/wanjarisaurabh/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/java-string
...
- `java.time` API
- Utility-based programs (Temperature Converter)

🔗 **Code Link:**  
👉 https://github.com/wanjarisaurabh/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/Extras
...
These programs are inspired by **real-world use cases** and implemented using Core Java concepts such as variables, loops, conditionals, arrays, methods, and basic OOP.

- BMI Fitness Tracker 🏃‍♂️  
- Bus Attendance System 🚌  
- Bus Route Distance Tracker 🛣️  
- Cafe Billing System ☕  
...
🔗 **Scenario Code Folder:**  
👉 https://github.com/wanjarisaurabh/BridgeLabz-Training/tree/core-java-practice/scenario-based  

---

## 🔹 LeetCode Practice

This section contains **problem-solving code** focused on:
- Logic building  
- Loops & conditions  
- Arrays & strings  
- Input/output handling  

🔗 **LeetCode Code Folder:**  
👉 https://github.com/wanjarisaurabh/BridgeLabz-Training/tree/core-java-practice/leet-code-codebase  
...
These programs are inspired by **real-world use cases** and implemented using **Core Java & OOP concepts** such as encapsulation, inheritance, abstraction, polymorphism, interfaces, and modular design.
...
- LoanBuddy (Loan Management System) 💰  
- MyBank Banking Application 🏦  
- ParkEase (Parking Management System) 🅿️  
- PetPal (Pet Care System) 🐾  
- SwiftCart (Grocery Shopping App) 🛒  

🔗 **Scenario Code Folder:**  
👉 https://github.com/wanjarisaurabh/BridgeLabz-Training/tree/java-oops-practice/java-oops-practice/scenario-based
